...
if (isset($_POST['nama'])) { 
    ...
    $sql = "INSERT INTO lat(nama,email,website,komentar) 
...
<body>
    ...
    <form action="utama.php" method="post" class="a">
        ...
        <table>
            ...
            <tr>
                ...
                <td><textarea name="komentar" id="komentar" cols="30" rows="10" required>masukan komentar</textarea></td>
    ...
    while($r=mysqli_fetch_array($hasil)){
      ...
      echo "<tr><td>$no</td><td>$r[nama]</td><td>$r[email]</td><td>$r[website]</td><td>$r[tanggal]</td><td>$r[komentar]</td></tr>";
